...
with(this){return _c('h3',{attrs:{"id":"6-some-common-names-are-not-allowed-to-be-entered"}},[_v("6. Some common names are not allowed to be entered"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#6-some-common-names-are-not-allowed-to-be-entered","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"7-currently-our-find-function-only-supports-finding-by-name"}},[_v("7. Currently, our find function only supports finding by name"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#7-currently-our-find-function-only-supports-finding-by-name","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 15:18:11 GMT+8]")])])])}
}];
